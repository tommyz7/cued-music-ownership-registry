...
//  * just the default.
//  */
// let createAssertionMessage = (passedMessage, defaultMessage) => {
...
// let assertEventListNotEmpty = (list, passedMessage, defaultMessage) => {
...
// let assertEventListEmpty = (list, passedMessage, defaultMessage) => {
//   const assertionMessage = createAssertionMessage(passedMessage, defaultMessage);
//   if (Array.isArray(list) && list.length !== 0) {
//     throw new AssertionError(assertionMessage);
//   }
...
// let getPrettyEventString = (eventType, args) => {
//   let argString = '';
...
//  */
// let getPrettyEmittedEventsString = (result) => {
...
// let assertEventEmittedFromTxResult = (result, eventType, filter, message) => {
//   console.log(result);
//   /* Filter correct event types */
//   const events = result.events.filter((entry) => {
...
// let assertEventNotEmittedFromTxResult = (result, eventType, filter, message) => {
//   /* Filter correct event types */
...
// let createTransactionResult = async (contract, transactionHash) => {
...
// let passes = async (asyncFn, message) => {
//   try {
//     await asyncFn;
//   } catch (error) {
...
// let fails = async (asyncFn, errorType, reason, message) => {
//   try {
//     await asyncFn;
//   } catch (error) {
