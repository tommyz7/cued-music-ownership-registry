...
var MusicRegistryPublic = artifacts.require("./mock/MusicRegistryPublic.sol");
var MusicLibPublic = artifacts.require("./mock/MusicLibPublic.sol");
...
contract("MusicRegistry", (accounts) => {
  ...
  before("deploy contracts", async () => {
    ...
    MusicLibPublic.link("MusicLib", Setup.MusicLib.address);
    Setup.MusicLibPublic = await MusicLibPublic.new({from: Setup.admin});
